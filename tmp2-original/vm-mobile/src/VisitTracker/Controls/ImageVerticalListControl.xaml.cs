...
public partial class ImageVerticalListControl : BaseContentView
{
    public ReactiveCommand<AttachmentDto, Unit> OpenAttachmentCommand { get; set; }

    public ImageVerticalListControl()
    {
        InitializeComponent();
    ...
    public static readonly BindableProperty AttachmentListProperty = BindableProperty.Create(nameof(AttachmentList),
            typeof(List<AttachmentDto>), typeof(ImageVerticalListControl),
    ...
    {
        var control = (ImageVerticalListControl)bindable;
