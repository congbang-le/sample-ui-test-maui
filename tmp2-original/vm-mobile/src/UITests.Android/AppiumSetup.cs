...
public class AppiumSetup
{
	...
	public void RunBeforeAnyTests()
	{
        ...
        androidOptions.AddAdditionalAppiumOption(MobileCapabilityType.NoReset, "false");
        androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.artivis.vm");

        //Make sure to set [Register("com.companyname.basicappiumsample.MainActivity")] on the MainActivity of your android application
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.artivis.vm.activity");
